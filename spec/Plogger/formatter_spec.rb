...
describe Plogger::Formatter do
  it "generates a message with the correct format" do
    ...
    expect(result).to eq("A message -- type='system' category='A Category' user_id=1 account_id=1 trace=a1234")
  end
  ...
  it "generates a message with the correct format when null values are submitted" do
    ...
    expect(result).to eq("A message -- type='system' category='' user_id=null account_id=null trace=a1234")
  end
  ...
  it "generates a message with the correct format when extra_info is submitted" do
    ...
    expect(result).to eq("A message -- type='system' category='' user_id=null account_id=null trace=a1234 module='Communication'")
  end
end
